...
export default function LandingPage() {
  ...
  const [chatMessages, setChatMessages] = useState([
    { role: "customer", text: "Hi, do you have the ankara set in size L? ≡ƒæù", time: "10:42 AM" },
  ]);
  ...
  const simulateNextChatStep = () => {
    if (chatStep === 0) {
      setChatMessages((prev) => [
        ...
        {
          role: "ai",
          text: "Yes! ≡ƒÄë We have the Premium Ankara Set in size L ΓÇö available in Navy Blue, Burgundy & Forest Green. It's Γéª45,000.\n\nWhich colour do you love? ≡ƒÿè",
          time: "10:42 AM",
        },
      ]);
      setChatStep(1);
      ...
      setChatMessages((prev) => [
        ...prev,
        { role: "customer", text: "Burgundy please! How do I pay? ≡ƒÆ│", time: "10:43 AM" },
      ]);
      setChatStep(2);
    } else if (chatStep === 2) {
      setChatMessages((prev) => [
        ...
        {
          role: "ai",
          text: "We accept bank transfer & Opay ≡ƒÅª\nZenith Bank - 1234567890\nAdaeze Fashion Hub Ltd\n\nSend receipt & I'll confirm instantly! Γ£à",
          time: "10:43 AM",
        },
      ]);
      setChatStep(3);
        ...
        >
          ...
          <div className="animate-fade-in" style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
            ...
            >
              ...
              Now live ΓÇö 500+ fashion vendors
            </div>
            ...
            >
              Stop replying to the same questions all day. SalesMate AI handles customer inquiries, recommends products, captures leads, and closes sales ΓÇö while you sleep.
            </p>
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: "13px", color: "var(--color-muted-foreground)", lineHeight: "1.5" }}>
                Customers get answers in under 2 seconds ΓÇö prices, sizes, availability, delivery. No more leaving people on read.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ fontSize: "13px", color: "var(--color-muted-foreground)", lineHeight: "1.5" }}>
                Upload your products once. The AI learns every detail ΓÇö colours, sizes, prices ΓÇö and answers questions accurately.
              </p>
            </div>
            ...
            >
              ...
              <p style={{ fontSize: "13px", color: "var(--color-muted-foreground)", lineHeight: "1.5" }}>
                Every interested customer is logged automatically ΓÇö name, number, what they asked. Your pipeline fills itself.
              </p>
            </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", width: "100%", padding: "0 var(--space-6)" }}>
          ...
          >
            ...
            <div style={{ padding: "16px var(--space-4)", borderLeft: "2px solid var(--color-primary)" }}>
              ...
              <p style={{ fontSize: "13px", color: "var(--color-muted-foreground)", lineHeight: "1.5" }}>
                Add your catalog ΓÇö photos, prices, sizes, colours. Takes about 5 minutes.
              </p>
            </div>
          ...
          >
            ...
            >
              <div>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "2px", margin: "16px 0" }}>
                  <span style={{ fontSize: "clamp(1.8rem, 2.5vw + 0.5rem, 2.4rem)", fontWeight: "800", color: "var(--color-foreground)" }}>Γéª9,900</span>
            ...
            >
              ...
              <div>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "2px", margin: "16px 0" }}>
                  <span style={{ fontSize: "clamp(1.8rem, 2.5vw + 0.5rem, 2.4rem)", fontWeight: "800", color: "#FFFFFF" }}>Γéª24,900</span>
            ...
            >
              <div>
                ...
                <div style={{ display: "flex", alignItems: "baseline", gap: "2px", margin: "16px 0" }}>
                  <span style={{ fontSize: "clamp(1.8rem, 2.5vw + 0.5rem, 2.4rem)", fontWeight: "800", color: "var(--color-foreground)" }}>Γéª59,900</span>
                  <span style={{ fontSize: "12px", color: "var(--color-muted-foreground)" }}>/month</span>
                </div>
                <p style={{ fontSize: "12px", color: "var(--color-muted-foreground)", marginBottom: "20px", lineHeight: "1.4" }}>
